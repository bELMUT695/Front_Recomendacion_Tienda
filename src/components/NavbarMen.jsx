  ...
  return (
    ...
    >
      ...
      <div className={click ? "navbar-left active" : "navbar-left"}>
        <ul>
          <li>
            <Link to="/men/all-clothes">Todos</Link>
          </li>
          <li>
            <Link to="/men/men-top-list">Mas Vendidos</Link>
          </li>

          <li>
            <Link to="/men/recommended-clothe">Recomendados</Link>
          </li>
          <li>
            <Link to="/men/recommended-clothe-cold">
